...
dmc1_locations: dict[str, BaseLocationData] = ({
    ...
    "Mission #2 - Rusty Key": BaseLocationData(mission_number=2, room_number=0, default_item=16, track_number=1),
    # M3
    ...
    "Secret Mission #12": BaseLocationData(mission_number=35, room_number=611, secret=True, default_item=35, track_number=1),
}|
