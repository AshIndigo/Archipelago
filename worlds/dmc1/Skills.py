...
weapon_skills: dict[str, ItemData] = {
    # Alastor
    "Alastor - Progressive Stinger": ItemData(100, ItemClassification.progression, 2),  # Two levels
    ...
    "Alastor - Progressive Vortex": ItemData(105, ItemClassification.useful, 2),  # Two levels

    # Ifrit
    "Ifrit - Rolling Blaze": ItemData(107, ItemClassification.useful),
    "Ifrit - Magma Drive": ItemData(108, ItemClassification.useful),
    "Ifrit - Progressive Kick 13": ItemData(109, ItemClassification.useful, 2),  # Two levels
    "Ifrit - Progressive Meteor": ItemData(111, ItemClassification.useful, 2),  # Two levels
